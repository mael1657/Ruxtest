        ...
        <View style={{padding:20,}}>
          ...
          <View style={{borderWidth:1,borderColor:'#eee',borderRadius:10,marginBottom:20,}}>
            ...
            style={{backgroundColor:'#EBEBEB',height:44,alignItems: 'center',justifyContent:'center',}}>
              <Text style={{fontSize:16,fontWeight:'bold'}}>견적서 보기</Text>
            </TouchableOpacity>
            <View style={{flexDirection: 'row',overflow: 'hidden',borderBottomLeftRadius: 10,borderBottomRightRadius: 10,}}>
                <TouchableOpacity style={{flex:1,backgroundColor:'#477DD1',height:57,justifyContent: 'center',alignItems: 'center',borderRightWidth:1,borderRightColor:'#fff'}}>
                    <Text style={{fontSize:16,fontWeight:'bold',color:'#fff'}}>견적 수정</Text>
                </TouchableOpacity>
                <TouchableOpacity style={{flex:1,backgroundColor:'#477DD1',height:57,justifyContent: 'center',alignItems: 'center',borderRightWidth:1,borderRightColor:'#fff'}}>
                    <Text style={{fontSize:16,fontWeight:'bold',color:'#fff'}}>견적 취소</Text>
                </TouchableOpacity>
                <TouchableOpacity style={{flex:1,backgroundColor:'#477DD1',height:57,justifyContent: 'center',alignItems: 'center'}}>
                    <Text style={{fontSize:16,fontWeight:'bold',color:'#fff'}}>채팅 하기</Text>
                </TouchableOpacity>
            </View>
          </View>
          {/* 내 견적 끝 */}
