                ...
                {item.map((arr,i) => 
                    (<View key={i}>
                        ...
                        <View>
                            ...
                            (arr2.ct_name3 ? <TouchableOpacity key={i2} style={styles.depth2} onPress={() => navigation.navigate('ProductRegistBrand', {ct_id: arr.ct_id, ct_id2: arr.ct_id2, ct_id3: arr.ct_id3})}>
