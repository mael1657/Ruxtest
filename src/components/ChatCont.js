...
export const ChatLeft = ({message,user}) => {
  return(
      <View style={{flexDirection:'row',marginBottom:10,}}>
        ...
        <Text style={{alignSelf:'flex-end',paddingLeft:10,fontSize:13,color:'#555',fontFamily:'NotoSansKR-Regular',lineHeight:20}}>오전 10:45</Text>
      </View>
  );
};
...
export const DealRequest = ({user,mine,estimate,dealtype} , {navigation}) => {
  return(
    <View style={{flexDirection:'row',marginBottom:20,maxWidth: 240,}}>
        ...
        <View>
          ...
          <View style={{padding:10,paddingVertical: 30,}}>
            <Text style={{fontSize:15,paddingBottom:10,fontFamily:'NotoSansKR-Regular',lineHeight:20}}>
                  <Text style={{fontFamily:'NotoSansKR-Medium'}}>판매자 {user}님</Text>께서
                  <Text style={{fontFamily:'NotoSansKR-Medium'}}> {mine}님의</Text>
                  <Text style={{color:'#477DD1',fontFamily:'NotoSansKR-Medium'}}> 견적 {estimate}원</Text>
                  <Text style={{fontFamily:'NotoSansKR-Medium'}}>으로 {dealtype}</Text>을 원합니다.
            </Text>
            <Text style={{fontSize:15,fontFamily:'NotoSansKR-Regular',lineHeight:20,}}>거래를 진행하시겠습니까?</Text>
          </View>
      ...
      <Text style={{alignSelf:'flex-end',paddingLeft:10,fontSize:13,fontFamily:'NotoSansKR-Regular',lineHeight:20,color:'#555'}}>오전 10:45</Text>
    </View>
  );
};
      ...
      <View style={{backgroundColor:'#fff',borderRadius: 8,overflow: 'hidden',minWidth:210,}}>
        <View style={{padding:10,paddingVertical:30,}}>
          <View style={{paddingBottom:10,}}>
              <Text style={{fontFamily:'NotoSansKR-Medium',lineHeight:20,fontSize:15,}}>판매자 {user}님께서</Text>
              <Text style={{fontSize:15,fontFamily:'NotoSansKR-Regular',lineHeight:20}}>거래 취소를 요청하셨습니다.</Text>
          </View>
          <Text style={{fontSize:15,fontFamily:'NotoSansKR-Regular',lineHeight:20}}>동의하시겠습니까?</Text>
        </View>
        <View style={{flexDirection:'row',}}>
          <TouchableOpacity style={{flex:1,backgroundColor:'#477DD1',height:54,alignItems: 'center',justifyContent: 'center',borderRightWidth:1,borderRightColor:'#fff'}}>
